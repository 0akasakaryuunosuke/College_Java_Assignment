    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            <div class="page-header">
                ...
                <p>
                    <span id="user_name">${USER_SESSION.userName}</span> <a id="unLogin" onclick="checklog1()" href="" >登录/注銷</a>
                </p>
            </div>
            <form id="searchForm" action="${pageContext.request.contextPath}/search" method="get" class="form-inline my-2 my-lg-0">
                <input type="text" id="searchKeyword" name="keyword" placeholder="Search articles">
...
<script>
    function redirectToSearch() {
        ...
        window.location.href = 'searchList?keyword=' + encodeURIComponent(keyword);
    }
</script>
    </body>
</html>